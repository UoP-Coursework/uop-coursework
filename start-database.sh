...
DB_CONTAINER_NAME="uop-coursework-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=uop-coursework -d -p 5432:5432 docker.io/postgres
